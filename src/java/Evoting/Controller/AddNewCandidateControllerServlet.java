...
//               name=files return from adminoptions.js
               String key=fit.getFieldName();
//               filename me like congress.jpg ayega
               String fileName=fit.getName();
               System.out.println("Inside else");
               System.out.println(key+":"+fileName);
           }
       }
       CandidateDTO candidate=new CandidateDTO(objValues.get(0),objValues.get(3),objValues.get(4),objValues.get(2),inp);
